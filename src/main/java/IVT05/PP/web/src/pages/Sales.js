...
export default class Sales extends Component {
    ...
    buy(cardId) {
        alert("Приобретено");
        document.getElementById("id" +cardId).style.display = 'none';
        localStorage.setItem(cardId, "buyed");
        console.log(localStorage.getItem("ID"));
    }

    componentDidMount() {
        fetch("http://localhost:8080/NFT")
            .then(res => res.json())
            .then(
                (result) => {
                    this.setState({
                            ...
                            <Row md={"4"} style={{
                                ...
                                <Card className={"m-2"} id="id1">
                                    ...
                                    <Card.Body>
                                        ...
                                        <Button onClick={this.buy.bind(this,"1")} variant={"outline-primary"} style={
                                            {
                                ...
                                <Card className={"m-2"} id="id2">
                                    ...
                                    <Card.Body>
                                        ...
                                        <Button onClick={this.buy.bind(this,"2")} variant={"outline-primary"} style={
                                            {
                                                borderRadius: "20px", marginBottom: "10px",
                                            }}>Купить</Button>
                                        <Card.Text className={"BTC"}>
                                ...
                                {this.state.items.map(item => (
                                    <>
                                        <Card className={"m-2"} id={"id"+item.id} key={item.id}>
                                            <Card.Img
                                                variant={"top"}
                                                src={item.img}
                                                height={"200"}
                                            ...
                                            <Card.Body>
                                                ...
                                                <Card.Text>{item.subname}</Card.Text>
                                                <Button onClick={this.buy.bind(this,"id"+item.id)} variant={"outline-primary"} style={
                                                    {
                                                        borderRadius: "20px", marginBottom: "10px",
                                                    }}>Купить</Button>
                                                <Card.Text className={"BTC"}>
